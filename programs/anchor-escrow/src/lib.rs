...
declare_id!("5m7t1HMGBkWoMgS8RKcW2J2SfYvEmYbioEMyntYd35QQ");
...
pub mod anchor_escrow {
    ...
    pub fn initialize(
        ...
        msg!("vault authority set to vault_authority pda made with escrow pda seeds");
